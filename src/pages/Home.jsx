      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative overflow-hidden max-w-5xl mx-auto rounded-2xl bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10 p-8 md:p-12 shadow-lg">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-textPrimary mb-4 flex items-center justify-center gap-0">
            ...
            <span className="-ml-1">
              Welcome to <span className="text-primary">NeuralHealer</span>
            </span>
          </h1>
          <p className="text-lg md:text-xl text-textSecondary mb-8 leading-relaxed max-w-3xl mx-auto">
            Your AI-powered therapy companion providing initial psychological support through 
            voice-based interaction. Get personalized guidance, connect with professionals, 
  ...
  <h2 className="text-3xl font-bold text-center text-textPrimary mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow duration-200 text-center">
            ...
            <h3 className="text-xl font-semibold text-textPrimary mb-2">Voice Interaction</h3>
            <p className="text-textSecondary">
              Speak naturally with our AI therapist using advanced speech recognition and text-to-speech technology.
            </p>
          </div>
          ...
          <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow duration-200 text-center">
            ...
            <h3 className="text-xl font-semibold text-textPrimary mb-2">Emotion Detection</h3>
            <p className="text-textSecondary">
              Our AI analyzes your emotional state and provides personalized support and coping strategies.
            </p>
          </div>
          ...
          <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow duration-200 text-center">
            ...
            <h3 className="text-xl font-semibold text-textPrimary mb-2">Professional Connection</h3>
            <p className="text-textSecondary">
              Book sessions with licensed psychologists for in-person or online therapy when you need professional help.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="rounded-xl bg-white shadow-md p-6 text-center">
            ...
            <div className="mt-1 text-sm text-textSecondary">Guided sessions completed</div>
          </div>
          <div className="rounded-xl bg-white shadow-md p-6 text-center">
            <div className="text-3xl md:text-4xl font-extrabold text-secondary">4.9/5</div>
            <div className="mt-1 text-sm text-textSecondary">Average user satisfaction</div>
          </div>
          <div className="rounded-xl bg-white shadow-md p-6 text-center">
            <div className="text-3xl md:text-4xl font-extrabold text-accent">24/7</div>
            <div className="mt-1 text-sm text-textSecondary">Always-on support</div>
          </div>
        </div>
      </div>
  ...
  <div className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-textSecondary mb-8">
            Take the first step towards better mental health with NeuralHealer
          </p>
          {!isLoggedIn && (
            <Link to="/register">
